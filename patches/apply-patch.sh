...
git apply -v ../../../device/acer/T03/patches/packages_apps_Settings/0001-Patch-for-6735-mtk.patch
cd ../../..
cd frameworks/opt/telephony
git apply -v ../../../device/acer/T03/patches/framework_opt_telephony/0001-Patch-for-6735-mtk.patch
cd ../../..
cd hardware/libhardware
git apply -v ../../device/acer/T03/patches/hardware_libhardware/0001-Patch-for-6735-mtk.patch
cd ../..
